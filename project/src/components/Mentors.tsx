    ...
    <section id="mentors" className="py-28 relative bg-night-950 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <div className="section-label justify-center">World-Class Faculty</div>
          <h2 className="font-display text-4xl lg:text-5xl font-bold text-ivory-100 mt-2">
            Learn from the <span className="gold-text">Best</span>
          </h2>
          <p className="text-ivory-500 mt-4 max-w-xl mx-auto leading-relaxed">
            Our mentors are practitioners, not just teachers — they've built the systems you'll learn to create.
          </p>
        </div>
          ...
          {MENTORS.map(mentor => (
            <div key={mentor.name} className="glass-card glass-card-hover rounded-2xl overflow-hidden group">
              ...
              <div className="p-5">
                ...
                <div className="text-gold-500 text-xs font-semibold mt-0.5">{mentor.title}</div>
                <div className="text-ivory-500 text-xs mt-0.5 mb-3">{mentor.company}</div>

                <p className="text-ivory-500 text-xs leading-relaxed mb-4">{mentor.bio}</p>
