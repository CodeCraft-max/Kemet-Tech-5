      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="font-display text-4xl lg:text-5xl font-bold text-ivory-100 mt-2">
            Lives <span className="gold-text">Transformed</span>
          </h2>
          <p className="text-ivory-500 mt-4 max-w-xl mx-auto leading-relaxed">
            Real results from real students who chose to invest in themselves.
          </p>
        </div>

        <div className="grid md:grid-cols-3 gap-6">
          {TESTIMONIALS.map(t => (
            <div key={t.name} className="glass-card glass-card-hover rounded-2xl p-7 relative group flex flex-col">
              <Quote
                size={48}
              ...
              <div className="flex items-center gap-3 pt-5 border-t border-white/5">
                ...
                />
                <div>
                  <div className="text-ivory-100 font-semibold text-sm">{t.name}</div>
                  <div className="text-ivory-500 text-xs">{t.title}</div>
                </div>
              </div>
            </div>
          ))}
